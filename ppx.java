...
public class ppx {
    ...
    private static String getData(String url) throws IOException {
        ...
        try {
            ...
            return getVideo(lzl ? object.getJSONObject("video").getString("uri")
    ...
    private static String getVideo(String video_id) throws IOException {
        ...
        return "video," + new String(Base64.getDecoder().decode(object.getJSONObject("video_"
